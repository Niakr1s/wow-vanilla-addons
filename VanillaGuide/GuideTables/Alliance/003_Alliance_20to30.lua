...
-----------21-22 Ashenvale
    ...
    [2122] = {
        ...
        items = {
            ...
            [14] = { str = "Make Astranaar your home. #HUTNERThen Stable your pet#" },
            ...
            [17] = { str = "#HUNTERTame a Clattering Crawler lvl 20 to get Claw Rank 3 give it Growl 3#"},
            [18] = { str = "do  #DOQUESTThe Zoram Strand#  Naga all around here." },
            [19] = { str = "And  #DOQUESTThe Ancient Statuette#  at 14,20 it’s on the ground. ", x = 14, y = 20, zone = "Ashenvale" },
            [20] = { str = "Turn in  #TURNINThe Ancient Statuette#  at 14,31 accept  #ACCEPTRuuzel#", x = 14, y = 31, zone = "Ashenvale" },
            [21] = { str = "Do  #DOQUESTRuuzel#  at 9,15 You don’t actually have to kill Ruuzel. Kill Lady Vespia. A 22 weak elite and doesn’t have guards like Ruuzel", x = 9, y = 15, zone = "Ashenvale" },
            [22] = { str = "Turn in  #TURNINRuuzel#  at 14,20.", x = 14, y = 20, zone = "Ashenvale" },
            [23] = { str = "Turn in  #TURNINRaene's Cleansing pt.1#  at 20,42 accept  #ACCEPTRaene’s Cleansing pt.2#  Kill murlocs for the gem", x = 20, y = 42, zone = "Ashenvale" },
            [24] = { str = "Hearth back to Astranaar" },
            [25] = { str = "Turn in  #TURNINThe Zoram Strand#  right as you enter town accept  #ACCEPTPridewings of Stonetalon#" },
            [26] = { str = "Go to the Inn Turn in  #TURNINRaene’s Cleansing pt.2#  accept  #ACCEPTRaene’s Cleansing pt.3#  and  #ACCEPTAn Aggressive Defense#" },
            [27] = { str = "Grind to 46,46 and accept  #ACCEPTElune's Tear#", x = 46, y = 46, zone = "Ashenvale" },
            [28] = { str = "Go to 49,56 then grind north to 53,46 turn in  #TURNINRaene’s Cleansing pt.3#  accept  #ACCEPTRaene’s Cleansing pt.4#.", x = 49, y = 56, zone = "Ashenvale" },
            [29] = { str = "You should already be level 22. Go to 55,61 and do  #DOQUESTAn Aggressive Defense#", x = 55, y = 61, zone = "Ashenvale" },
            [30] = { str = "Hearth to Astranaar" },
            [31] = { str = "Turn in  #TURNINAn Aggressive Defense#" },
            [32] = { str = "Go to the east exit house, turn in  #TURNINElune's Tear#  accept  #ACCEPTThe Ruins of Stardust#" },
            [33] = { str = "Exit Astranaar out the east exit follow the south path till you are at 33,66 and grab stardust covered bushes for  #DOQUEATThe Ruins of Stardust#", x = 33, y = 66, zone = "Ashenvale" },
            [34] = { str = "Grind east to Talondeep path at 42,71", x = 42, y = 71, zone = "Ashenvale" },
        }
    },
...
-----------24-25 Ashenvale
    ...
    [2425] = {
        ...
        items = {
            ...
            [12] = { str = "Go to 49,56 then grind north to 53,46 turn in  #TURNINRaene’s Cleansing pt.3#  accept  #ACCEPTRaene’s Cleansing pt.4#.", x = 53, y = 46, zone = "Ashenvale" },
            [13] = { str = "Run down to Silverwing Refuge at 49,67 and accept #ACCEPTElemental Bracers# do it in the lake here.", x = 49, y = 67, zone = "Ashenvale" },
            [14] = { str = "Once you have all 5 inact bracers, use the scroll on them and then hand it back in at 49,67 SKIP  #VIDEOMage Summoner#. ", x = 49, y = 67, zone = "Ashenvale" },
            [15] = { str = "I’m usually about 1 bar from level 25 so I grind to level 25 on the elementals " },
            [16] = { str = "Hearth to Auberdine" },
            [17] = { str = "Get on the boat to Menethil Harbor." },
        }
    },
...
-----------25-27 Wetlands
    ...
    [2526] = {
        ...
        items = {
            ...
            [7] = { str = "Make Menethil Harbor your home" },
            [8] = { str = "Go upstairs in the inn, turn in  #TURNINThe Absent Minded Prospector pt.4#  accept  #ACCEPTThe Absent Minded Prospector pt.5#" },
            [9] = { str = "Buy a  #NPCFlagon of Mead#  from the bartender for  #DOQUESTThe Third Fleet#  and give it to the guy outside the inn. Accept  #ACCEPTThe Cursed Crew#" },
            [10] = { str = "On the bridge accept  #ACCEPTIn Search of the Excavation Team pt.1#" },
            [11] = { str = "Kill Young Crocolisks just east of the bridge around 14,52 and north on the land of the lake also along the road to the greenwarden for  #DOQUESTYoung Crocolisk Skins#", x = 14, y = 52, zone = "Wetlands" },
            [12] = { str = "Kill Bluegill Murlocs and Gobbler at 18,40 for  #DOQUESTClaws From the Deep#", x = 18, y = 40, zone = "Wetlands" },
            [13] = { str = "Kill Mottled Raptors and Screechers around 25,46 for  #DOQUESTThe Absent Minded Prospector pt.5#", x = 25, y = 46, zone = "Wetlands" },
            [14] = { str = "Enter the Excavation Site at 34,40.", x = 34, y = 40, zone = "Wetlands" },
            [15] = { str = "Run up the path on the left and grab the fossil near the 2 npc’s at 38,52 for  #DOQUESTThe Absent Minded Prospector pt.5#", x = 38, y = 52, zone = "Wetlands" },
            [16] = { str = "Turn in  #TURNINIn Search of the Excavation Team pt.1#  accept  #ACCEPTIn Search of the Excavation Team pt.2#" },
            [17] = { str = "Accept  #ACCEPTUncovering the Past#." },
            [18] = { str = "Outside the cave accept  #ACCEPTOrmer s Revenge pt.1.#" },
            [19] = { str = "Go back to where you killed the raptors a few minutes ago at 25,46 and do  #DOQUESTOrmer's Revenge pt.1#  by killing mottled raptors and screechers.", x = 25, y = 46, zone = "Wetlands" },
            [20] = { str = "Run back up to the cave at 38,52 and turn in  #TURNINOrmer's Revenge pt.1#  accept  #ACCEPTOrmer’s Revenge pt.2#", x = 38, y = 52, zone = "Wetlands" },
            [21] = { str = "Now do both  #DOQUESTOrmer’s Revenge pt.2#  by killing Scythclaw and Razormaw Raptors below, and  #DOQUESTUncovering the Past#  relics for this are all around the raptors. There are 4 different ones that randomly spawn but each is in it’s own shape which are: (Modr=Thin Red Vase) (Golm=Fat Yellow Vase) (Neru=Dirt Pile) (Ados=Tomb)." },
            [22] = { str = "Go back up to 38,52 and turn in  #TURNINOrmer’s Revenge pt.2#  accept  #ACCEPTOrmer’s Revenge pt.3#", x = 38, y = 52, zone = "Wetlands" },
            [23] = { str = "Turn in  #TURNINUncovering the Past#" },
            [24] = { str = "Do  #DOQUESTOrmer’s Revenge pt.3#  atop the hill at 32,51 #NPCSarltooth# is a 29 But he’s as easy as the others. Go turn it back in at 38,52.", x = 32, y = 51, zone = "Wetlands" },
            [25] = { str = "Go in to Angerfang Encampment at 43,40 and do  #DOQUESTWar Banners#", x = 43, y = 40, zone = "Wetlands" },
            [26] = { str = "Stop at 49,39 accept #ACCEPTDaily Delivery#.", x = 49, y = 39, zone = "Wetlands" },
            [27] = { str = "Run straight East from here to 56,40 and turn in  #TURNINThe Greenwarden#  accept  #ACCEPTTramping Paws#", x = 56, y = 40, zone = "Wetlands" },
            [28] = { str = "Kill #NPCMosshide# around 56,74 for  Tramping Paws  at the camp. They’re a fast respawn I couldn’t kill them fast enough. Turn it in at 56,40 and accept  #ACCEPTFire Taboo#  You should be level 26 by now, if not you will be soon", x = 56, y = 74, zone = "Wetlands" },
            [29] = { str = "Do  #DOQUESTFire Taboo#  by killing any mosshides but the ones you just killed, The flints are easily dropped by the ones around 44,33 there is a few.", x = 44, y = 33, zone = "Wetlands" },
            [30] = { str = "Turn in  #TURNINFire Taboo#  at 56,40 accept  #ACCEPTBlisters on the Land#  Now this is one of those quests you just do as you go. Fen Creepers are stealthed elementals that lurk in the water. If you see one, kill it.", x = 56, y = 40, zone = "Wetlands" },
            [31] = { str = "Hearth back to Menethil Harbor." },
            [32] = { str = "Turn in  #TURNINThe Absent Minded Prospector pt.5#  2nd floor of the Inn" },
            [33] = { str = "Go inside the castle upstairs, turn in  #TURNINWar Banners#  accept  #ACCEPTNek'Rosh's Gambit#" },
            [34] = { str = "On the west side of town turn in #TURNINDaily Delivery# and  #TURNINYoung Crocolisk Skins#  accept  #ACCEPTApprentice's Duties#" },
            [35] = { str = "Go on the dock and turn in  #TURNINClaws From the Deep#  accept  #ACCEPTReclaiming Goods#" },
            [36] = { str = "On the bridge turn in  #TURNINIn Search of the Excavation Team pt.2#." },
            [37] = { str = "You should definitely be level 26 by this point and near ½ way to 27. You can either wait till you fly through IF to get talents or do it now." },
            [38] = { str = "Touch the damaged crate at 13,41 turn in  #TURNINReclaiming Goods#  accept  #ACCEPTThe Search Continues#.", x = 13, y = 41, zone = "Wetlands" },
            [39] = { str = "Go just north to the next camp touch the sealed barrel at 13,38 turn in  #TURNINThe Search Continues#  accept  #ACCEPTSearch More Hovels#.", x = 13, y = 38, zone = "Wetlands" },
            [40] = { str = "Go north again touch the half-burried barrel at 13,34 turn in  #TURNINSearch More Hovels#  accept  #ACCEPTReturn the Statuette#", x = 13, y = 34, zone = "Wetlands" },
            [41] = { str = "Stop at the sunken ships around 14,28 14,25 and kill the undead on either ship for  #DOQUESTThe Cursed Crew#  Try to stay on top of the ships. Kill #NPCSnellig# in the broken part of the first ship in the rear near the shore for the box.", x = 14, y = 28, zone = "Wetlands" },
            [42] = { str = "From here north you should be able to find Giant crocolisks for  #DOQUESTApprentice's Duties#  as well as the fen dwellers (track hidden) in the waters all over this area while you head toward Ironbeard’s Tomb at 44,25 for  #DOQUESTDigging Through the Ooze#  Kill oozes for the bag.", x = 44, y = 25, zone = "Wetlands" },
            [43] = { str = "Now once all your fen creepers are dead head back to the greenwarden at 56,40 and hand it in.", x = 56, y = 40, zone = "Wetlands" },
            [44] = { str = "Hearth Back to Menethil Harbor." },
            [45] = { str = "Just outside turn in  #TURNINThe Cursed Crew#  accept  #ACCEPTLifting the Curse#." },
            [46] = { str = "Go north a little bit and turn in  #TURNINDigging Through the Ooze#" },
            [47] = { str = "Go to the west side of town, turn in  #TURNINApprentice's Duties#." },
            [48] = { str = "Next down to the docks, turn in  #TURNINReturn the Statuette#" },
            [49] = { str = "You should be level 27 now. " },
            [50] = { str = "Fly to IF, get new skills, turn in  #TURNINAn Old Colleague#  at 71,51 SKIP the next part", x = 71, y = 51, zone = "Wetlands" },
            [51] = { str = "Fly to SW, turn in  #TURNINA Gnome’s Respite#  at 43,80 SKIP the next part", x = 43, y = 80, zone = "Wetlands" },
            [52] = { str = "Fly to Lakeshire" },
        }
    },
...
-----------29-30 Ashenvale
    ...
    [2930] = {
        ...
        items = {
            ...
            [2] = { str = "1) Make Astranaar your home." },
            [3] = { str = "2) Stable your pet then head out East" },
            [4] = { str = "#HUNTER3) Tame an Elder Ashenvale Bear to the east of Raynewood Retreat, Give it growl and use if for the following#" },
            [5] = { str = "4) Stop at 66,56 and touch the crystal for the first part of  #DOQUESTThe Tower of Althalaxx pt.6#.", x = 66, y = 56, zone = "Ashenvale" },
            [6] = { str = "5) Kill Withered Ancients for the Wooden Key for  #DOQUESTRaene’s Cleansing pt.4#  around 55,35 then use the key on the chest at 54,35", x = 55, y = 35, zone = "Ashenvale" },
            [7] = { str = "6) Run to 53,46 turn in  #TURNINRaene’s Cleansing pt.4#  accept  #ACCEPTRaene’s Cleansing pt.5#", x = 53, y = 46, zone = "Ashenvale" },
            [8] = { str = "7) Go to 85,44 and turn in  #TURNINKayneth Stillwind#  accept  #ACCEPTForsaken Diseases#", x = 85, y = 44, zone = "Ashenvale" },
            [9] = { str = "8) Go to 81,48 and get the second part of  #ACCEPTThe Tower of Althalaxx pt.6#", x = 81, y = 48, zone = "Ashenvale" },
            [10] = { str = "9) Go to 66,81 and do  #DOQUESTFallen Sky Lake#  the mob is in the center", x = 66, y = 81, zone = "Ashenvale" },
            [11] = { str = "10) Kill rotting slimes until a chest falls east of the road near the lake for  #DOQUESTRaene’s Cleansing pt.5#" },
            [12] = { str = "11) Go to 75,71 and do  #DOQUESTForsaken Diseases#  the bottle is on the table.", x = 75, y = 71, zone = "Ashenvale" },
            [13] = { str = "12) Hand in  #TURNINForsaken Diseases#  at 85,44 SKIP the next part.", x = 85, y = 44, zone = "Ashenvale" },
            [14] = { str = "13) Hearth back to Astranaar" },
            [15] = { str = "14) Turn in  #TURNINFallen Sky Lake#  at the last house on the east side of town" },
            [16] = { str = "15) Go to 53,46 turn in  #TURNINRaene’s Cleansing pt.5#  accept  #ACCEPTRaene's Cleansing pt.5#  Go turn it in at the shrine inside the tree at 56,49 accept  #ACCEPTRaene’s Cleansing pt.6#   Turn it back in at the moonwell at 53,46 accept  #ACCEPTRaene’s Cleansing pt.7#  die so you end up near town", x = 53, y = 46, zone = "Ashenvale" },
            [17] = { str = "16) Hand in  #TURNINRaene’s Cleansing pt.7#  at the Inn, SKIP the rest but keep the rod, you can use it forever to transform for fun =P" },
            [18] = { str = "17) Go to 26,38 turn in  #TURNINThe Tower of Althalaxx pt.6#  SKIP the rest", x = 26, y = 38, zone = "Ashenvale" },
            [19] = { str = "18) Fly to Darnassus and get your level 30 talents" },
            [20] = { str = "19) Fly to Auberdine then get on the boat to Menethil Harbor" },
        }
    },
