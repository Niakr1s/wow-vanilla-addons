...
-----------18-20 Redridge Mountains
	...
	[1820] = {
		...
		items = {
			...
			[19] = { str = "Do  #DOQUESTAssessing the Threat#  at 29,83 and 41,73.", x = 41, y = 73, zone = "Redridge Mountains"},
			[20] = { str = "Kill condors for  #DOQUESTRedridge Goulash#  around 57,73", x = 57, y = 73, zone = "Redridge Mountains" },
			[21] = { str = "Turn in  #TURNINAssessing the Threat#  near the FP" },
			[22] = { str = "Accept  #ACCEPTMurloc Poachers#  in front of the shed." },
			[23] = { str = "Stop at the house just west of Lakeshire, turn in  #TURNINVisit the Herbalist#  accept  #ACCEPTDelivering Daffodils#" },
			[24] = { str = "Go to the next house, turn in  #TURNINRedridge Goulash#" },
			[25] = { str = "Go in the Inn and turn in  #TURNINDelivering Daffodils#." },
			[26] = { str = "Kill Murlocs east of the bridge for  #DOQUESTMurloc Poachers#." },
			[27] = { str = "Kill Gnolls north of Lakeshire for  #DOQUESTThe Everstill Bridge#." },
			[28] = { str = "Turn in  #TURNINThe Everstill Bridge#  next to the Bridge" },
			[29] = { str = "Turn in  #TURNINMurloc Poachers#  in front of the shed." },
			[30] = { str = "Hearth back to Auberdine. You should definitely be level 20 by this point and at least half way to level 21." },
		}
	},
}
